            ...
            try:
                ...
                if response.status_code == 200:
                    ...
                    if report_list:
                        ...
                        st.success("🌟 100% Content Integrity!")
