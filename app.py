...
st.markdown("""
    ...
    /* Scoreboard Metrics - Vertical Stacking Guaranteed */
    .metric-card {
...
# --- 3. SIDEBAR (Full Instructions restored and locked) ---
with st.sidebar:
    ...
    if not all([subdomain, email, token]):
        ...
        try:
            ...
            for i, art in enumerate(articles):
                ...
                # Logic gated by Tuning Layer toggles
            ...
            dl_area.download_button("📥 DOWNLOAD REPORT", pd.DataFrame(results).to_csv(index=False), "zenaudit_report.csv", "text/csv")
